...
public class MayinTarlasi extends JFrame implements ActionListener, ContainerListener {
    ...
    public void setpanel(int level, int setr, int setc, int setm) {
        ...
        blocks = new JButton[satir_block][sütun_block];
                ...
                if (e.getSource() == blocks[i][j]) {
                    if (e.isMetaDown() == false) {
                        ...
                        if (mayin_sayaci[i][j] == -1) {
                            ...
                            blocks[i][j].setIcon(ic[mayin_sayaci[i][j]]);
    ...
    public void dfs(int row, int col) {
        ...
        blocks[row][col].setIcon(ic[mayin_sayaci[row][col]]);
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (R >= 0 && R < satir_block && C >= 0 && C < sütun_block && renk[R][C] == 'w') {
                if (mayin_sayaci[R][C] == 0) {
                    ...
                    blocks[R][C].setIcon(ic[mayin_sayaci[R][C]]);
    ...
    class Customizetion extends JFrame implements ActionListener {
        ...
        Customizetion() {
            ...
            lb2 = new JLabel("Width");
            lb3 = new JLabel("Mines");
